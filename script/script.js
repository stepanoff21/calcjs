...
const startButton = document.querySelector('.start-button'),
  ...
  desktopTemplatesCheckBox = document.getElementById('desktopTemplates'),
  adaptCheckBox = document.getElementById('adapt'),
  mobileTemplatesCheckBox = document.getElementById('mobileTemplates'),
  editableCheckBox = document.getElementById('editable'),
...
function handlerCallBackForm(event) {
  ...
  desktopTemplatesValue.textContent = desktopTemplatesCheckBox.checked ? 'Да' : 'Нет';
  adaptValue.textContent = adaptCheckBox.checked ? 'Да' : 'Нет';
  mobileTemplatesValue.textContent = mobileTemplatesCheckBox.checked ? 'Да' : 'Нет';
  editableValue.textContent = editableCheckBox.checked ? 'Да' : 'Нет';  
